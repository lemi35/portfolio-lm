...
const projects = [
  {
    ...
    github: "https://github.com/lemi35/fraud_detection_app",
  },
  {
    title: "Qualtrics survey and JS processing",
    description:
      "Quick simple project to test Qualtrics, where free API unfortunately doesn't work, so I downloaded CSV and processed the data locally for visualization. No live demo available.",
    link: "",
    img: "/survey.jpeg",
  ...
  },
  {
    ...
    description:
      "This is the backend API with frontend in development for a Dance school website on the basis of LMS functionality. It provides all the core functionalities for managing users, courses, categories, layouts, notifications, orders, and analytics. Built with Node.js, Express, and MongoDB. No live demo available.",
    link: "",
    img: "/hennigan.jpeg",
    tags: [
      "TypeScript",
  ...
  },
  {
    title: "Pawsome",
    description:
      "A pet food tracking application built with React, Firebase and Antigravity API.",
  ...
  },
  {
    title: "Chart-app",
    description:
      "Chart App is an interactive, responsive Angular dashboard that visualizes data using Highcharts, featuring filtering, multiple chart types, and local storage persistence.",
  ...
  },
  {
    title: "Caffiend",
    description:
      "Coffee consumption tracker app built with React and Firebase. Playwright testing of login and basic functionality",
  ...
  },
  {
    title: "ShowFinder",
    description:
      "A film and TV show search application built with React and IMDB API.",
  ...
  },
  {
    title: "ToDo App",
    description:
      "A simple to-do list application built with Svelte and Firebase.",
  ...
  },
  {
    ...
    description:
      "An online shop for Irish dance supplies built with React. UI only with search and filter functionality.",
